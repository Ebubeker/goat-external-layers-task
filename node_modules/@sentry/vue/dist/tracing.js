...
function getActiveTransaction() {
    var _a;
    return (_a = browser_1.getCurrentHub().getScope()) === null || _a === void 0 ? void 0 : _a.getTransaction();
}
...
exports.createTracingMixins = function (options) {
    var e_1, _a;
    var hooks = (options.hooks || [])
        .concat(constants_1.DEFAULT_HOOKS)
    ...
    try {
        for (var hooks_1 = tslib_1.__values(hooks), hooks_1_1 = hooks_1.next(); !hooks_1_1.done; hooks_1_1 = hooks_1.next()) {
